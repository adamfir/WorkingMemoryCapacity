<head>
        ...
        function timer() {
                ...
                if(seconds == 0){
                window.location = "/tester/reading-span-task/sentence";
...
<body style ="background-color: #d2d6de" > 
        ...
        <div class="divClass" >
                <center><h1 class="textQuest">Sapi</h1></center>
                <center><h1 class="textQuest">Makan</h1></center>
                <center><h1 class="textQuest">Nasi</h1></center>
        </div>
